...
public class CONFIG {
	...
	public static final String localip = "localhost";//"192.168.1.254";
	public static final String zombieserverip = "localhost";//"192.168.1.254";
	...
	public static final String room = "room1";
