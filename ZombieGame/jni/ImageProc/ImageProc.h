...
int Java_be_csmmi_zombiegame_rendering_MjpegInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_be_csmmi_zombiegame_rendering_MjpegInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
